...
import side3 from "../../public/images/side-4-dark.svg";
...
const LevelOneSoc = ({}) => { const [time, setTime] = useState("");
          ...
          >
            ...
            <div id="body">
              ...
              <div class="p-6 lg:py-6 text-center lg:text-lg">
                <p>
                  Not Necessary, If you want we can assign you a social leader then you'll be able to see all
                  his trades and reset your trades to mimick his.
                </p>
              </div>
            </div>
          </div>
