...
const LevelOneAut0 = ({}) => { const [time, setTime] = useState("");
...
const logoutHandler = () => {
  ...
  return (
    ...
    <div>
      <div id="membership-cont" class="w-full">
      ...
      <div
        ...
        >
          ...
          <Link
              href="/dashboard" id="sidebar-item" class=" flex items-center text-white py-3">
            ...
            <Link
              href="/dashboard/trading" id="sidebar-item" class=" flex items-center text-white py-3">
              <div class="mr-3 ml-5">
                <Image src={side2} />
              </div>
            ...
            <Link
              href="/dashboard/social" id="sidebar-item" class=" flex items-center text-white py-3">
              <div class="mr-3 ml-5">
                <Image src={side3} />
              </div>
            ...
            <Link
              href="/dashboard/history" id="sidebar-item" class=" flex items-center text-white py-3">
              <div class="mr-3 ml-5">
                <Image src={side4} />
              </div>
          ...
          >
            ...
            <div id="body">
              ...
              <div class="p-6 lg:py-6 text-center lg:text-lg">
                <p>
                  We're handling and automating everything concerning your
                  account, don't worry.
                </p>
              </div>
            </div>
