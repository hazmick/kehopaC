...
import side2 from "../../public/images/trading-light.svg";
...
const LevelOneTra = ({}) => { const [time, setTime] = useState("");
        ...
        >
          ...
          <div id="smald3" class="hidden xl:flex flex-col pt-8 pb-12">
            <Link
              href="/dashboard"
              id="sidebar-item"
              class=" text-white items-center flex py-3"
            >
              <div class="mr-3 ml-5">
                <Image src={light} />
              </div>
            ...
            <Link
              ...
              id="sidebar-item"
              class="my-1 text-white items-center flex py-3"
            >
              <div class="mr-3 ml-5">
                <Image src={side3} />
              </div>
          ...
          >
            ...
            <div id="body">
              ...
              <div class="p-6 lg:py-6 text-center lg:text-lg">
                ...
                No need to learn the hard way. Your bots have are already
                  running from presets to start off on the right foot.
                </p>
              </div>
            </div>
          </div>
