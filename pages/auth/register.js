...
const Register = ({ history }) => {
  ...
  const registerHandler = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        "https://upset-bee-overcoat.cyclic.app/api/auth/register",
  ...
  return (
    ...
    <div class="pb-16 lg:pb-0">
      ...
      <div class="lg:pt-36 pt-28 text-gray-900 lg:pb-8 pb-4 text-2xl lg:text-3xl text-center uppercase font-extrabold">
      ...
      >
        ...
        <div class="py-4 flex items-center">
          <input type="checkbox" id="verify" required name="verify" />
          <label for="veri" htmlFor="veri" class="pl-3 text-sm">
            By creating an account, you agree to Hazmick{" "}
        ...
        <div class="lg:py-8 pt-4 flex flex-col lg:flex-row justify-between lg:items-end">
          ...
          <Link
            href="/auth/login"
            class="underline inline-block text-blue-300 pt-6 lg:pt-0 cursor-pointer font-bold hover:text-blue-600"
          >
